...
To obtain contact maps from conformations saved by sampleSimulation.py, please use the funciton openmm-polymer.contactmaps.pureMap(). 

Later these files will be updated to automate calculation of the contact frequency ratio (as defined in the manuscript). 
